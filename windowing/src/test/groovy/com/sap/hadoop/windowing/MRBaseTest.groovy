...
abstract class MRBaseTest
{
	...
	public static final String TEST_GIT_PATH = "C:/Users/d055212/Documents/"
	...
	public static Configuration WORK_LOCALMR()
	{
		...
		//conf.set("hive.metastore.uris", "thrift://localhost:9083");
		conf.set("hive.metastore.local", "false");
		conf.set("windowing.jar.file", "C:/Users/d055212/Documents/SQLWindowing/windowing/target/com.sap.hadoop.windowing-0.0.2-SNAPSHOT.jar");

		conf.set(Constants.HIVE_THRIFTSERVER, "hbserver7.dhcp.pal.sap.corp")
		conf.setInt(Constants.HIVE_THRIFTSERVER_PORT, 10000)
		conf.set("HIVE_HOME", "C:/hive-0.9.0-bin")
